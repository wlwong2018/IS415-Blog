...
Learn how to using R Stat function to calibrate the Spatial Interaction Models. Instead of using *lm()* the *glm()* **function will be used**. This is because *glm()* allows us to **calibrate the model using generalised linear regression methods**.
