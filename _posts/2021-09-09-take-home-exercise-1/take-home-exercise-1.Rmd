...
packages <- c('readxl', 'tidyr', 'dplyr', 'readr', 'ggplot2', 'ggpubr', 'sf', 'tmap') #'fs', 'rmapshaper', 'rgdal' , 'ggpubr'
for (p in packages){
...
### 4.1.6 Pivot date values to columns for calculation of cumulative positive cases & deaths
