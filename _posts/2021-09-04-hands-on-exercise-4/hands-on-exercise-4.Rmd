...
tm_shape(childcare_sf)+
  tm_dots()
```
<left> REMEMBER to switch back to plot mode afer plotting interactive maps </left> 
```{r echo=TRUE, eval=TRUE}
tmap_mode('plot')
...
3) Make each point “unique” and then attach the duplicates of the points to the patterns as marks, as attributes of the points. (need nalytical techniques that take into account these marks.)
